...
export default function PricingSection() {
  return (
    <section id="pricing" className="py-24 px-6 bg-white overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            <span className="text-cyan-600 italic font-medium">Health Journey</span>
          </motion.h2>
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-stretch mb-12">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <div className="mb-8">
                <div className={`size-12 rounded-2xl flex items-center justify-center mb-6 ${plan.highlight ? 'bg-cyan-600 text-white' : 'bg-white text-cyan-600 shadow-sm'}`}>
              ...
              <div className="space-y-4 mb-10 flex-grow">
                {plan.features.map((feature, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <Check className={`w-5 h-5 shrink-0 ${plan.highlight ? 'text-cyan-600' : 'text-slate-400'}`} />
                    <span className="text-sm text-slate-600 font-medium">{feature}</span>
                  </div>
                ))}
              </div>

              <button className={`w-full py-4 rounded-xl font-black uppercase text-[11px] tracking-widest transition-all ${
                plan.highlight 
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-2">Corporate / Hospital Plan</h3>
              <p className="text-slate-400 max-w-md text-sm leading-relaxed">
                For organizations and institutions. Includes risk analytics system, dedicated support, and institutional monitoring.
              </p>
            </div>
          </div>
          <div className="shrink-0">
             <div className="text-sm font-bold text-cyan-400 uppercase tracking-widest mb-4 md:text-right">Contact for Custom Pricing</div>
